...
function getTask($task_id)
{
    ...
    try {
        $statement = $db->prepare('SELECT id, task, status, id_user FROM tasks WHERE id=:id');
...
function createTask($data, $id_user)
{
    global $db;

    try {
        $statement = $db->prepare('INSERT INTO tasks (task, status, id_user) VALUES (:task, :status, :id_user)');
